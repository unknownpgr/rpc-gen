...
function generate(config = {
    ...
    for (const sourceFile of sourceFiles) {
        ...
        functionDeclarations.forEach(({ params, returnType, functionName }) => {
            ...
            if (!firstParameter) {
                throw new Error(`Invalid api function declaration: ${moduleName}.${functionName}. There must be at least one RpcContext type parameter.`);
            }
            // Assert the type of first parameter is RpcContext.
            ...
            const funcParamsWithTypes = params
                ...
                .join(", ");
            let resolvedReturnType = (0, resolver_1.resolveType)(returnType, resolvedTypes);
